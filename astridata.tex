...
\tem{Abbiamo discusso con Alessio la presentazione di questi risultati e non è chiaro per noi se mettere una tabella o i plot in funzione del tempo come quelli della figura seguente}

\begin{figure*}[ht!!]
\includegraphics[angle=0, width=10.5cm]{Figure/ASTRI_bkg_20181208_20181209.pdf}
\includegraphics[angle=0, width=10.5cm]{Figure/ASTRI_bkg_20180305_20180306.pdf}
\vspace{0.5cm}
