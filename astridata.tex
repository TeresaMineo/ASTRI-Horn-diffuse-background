...
The light produced by the FOC is uniform and its intensity provide an average of few $p.e.$ per pixel. Figure~\ref{fig:FOC} shows the pulse height spectrum acquired in one of the FOC run listed in Table~\ref{table2} with a fixed voltage $V_{0}$= 57 V  and a temperature of 15$^\circ$C for a camera pixel in the high gain electronics chain. 
